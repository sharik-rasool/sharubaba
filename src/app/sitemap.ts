...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
    ...
    const staticPages: MetadataRoute.Sitemap = [
        ...
        { url: `${BASE_URL}/link-builder-uk`,   lastModified: new Date(), changeFrequency: "weekly",  priority: 0.85 },
        { url: `${BASE_URL}/seo-specialist-uk`, lastModified: new Date(), changeFrequency: "weekly",  priority: 0.85 },
